...
**Every paper/manuscript file MUST be reviewed before any commit or PR.**
...
3. Saves report to `.claude/session-reports/` (e.g., `.claude/session-reports/LectureN_Topic_report.md`)
