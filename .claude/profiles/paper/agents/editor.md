...
Write to `.claude/session-reports/peer_review_[sanitized_paper_name]/desk_review.md`:
...
Write to `.claude/session-reports/peer_review_[paper]/editorial_decision.md`:
