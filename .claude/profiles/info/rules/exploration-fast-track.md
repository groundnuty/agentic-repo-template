...
2. **Create folder** -- `mkdir -p explorations/[name]/` + subdirs your stack needs (e.g. `src/`, `scripts/`, `output/`, `R/`, `notebooks/`) + README + SESSION_LOG.md
3. **Code immediately** -- no plan needed. Must-haves: code runs, results correct, goal documented. Not needed: full docs, full tests, perfect style.
